...
function toggleDatePicker(e) {
  ...
  while (targetElement !== null) {
    if (
      ...
      targetElement.classList.contains("dates-container")
    ) {
      return; // If the target element has the class "dates-container", exit the function
    }
    targetElement = targetElement.parentElement; // Move up to the parent element
  }

  // If the loop finishes without finding the "dates-container" class, toggle the class on the "dates_ele" element
